#
# see http://www.win-vector.com/blog/2014/05/a-clear-picture-of-power-and-significance-in-ab-tests/
#
...
r1 <- designExperiment(pA=0.005,pB=0.006,pError=0.05)
print(r1$plot)
...
r3 <- designExperiment(pA=0.05,pB=0.06,pError=0.01,
                       pAUpper=0.055,pBLower=0.055)
print(r3$plot)